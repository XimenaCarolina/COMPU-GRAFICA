...
int main() {
    ...
    Shader ourShader("Shader/core.vs", "Shader/core.frag");  //shaders de vertices y fragmentos 

	// Set up vertex data (and buffer(s)) and attribute pointers
	float vertices[] = {
		0.5f,  0.5f, 0.0f,    1.0f,0.0f,0.0f,  // top right  , tiene 3 de posicion y 3 de color 
